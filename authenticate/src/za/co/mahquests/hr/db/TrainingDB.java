...
public class TrainingDB {
    ...
    public static void deleteMonthTraining(int month){
        ...
        for (Object list : trainingDB) {
            ...
            if(listedDate.isAfter(startDate) && listedDate.isBefore(endDate)) {
                ...
                trainingDB.remove(list);

            } else
                {
                System.out.println("No training scheduled this month");
            }
     ...
     /*
        ...
        for (int count = 0; count > trainingDB.size(); count++) {

            LocalDate listedDate = ((Training) trainingDB.get(count)).getStartDate();

            if(listedDate.isAfter(startDate) && listedDate.isBefore(endDate)) {
                System.out.println(count + " " + ((Training) trainingDB.get(count)).getStartDate() + " " + ((Training) trainingDB.get(count)).getTrainingTitle() );
